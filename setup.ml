...
(* OASIS_START *)
(* DO NOT EDIT (digest: a04f35caa9c81ee63fa2d0cb3b0e3a7a) *)
(*
...
let setup_t =
  {
            ...
            [
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("erm_xml",
                               Some (OASISVersion.VGreaterEqual "0.3"));
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "erm_xmpp";
                           FindlibPackage ("erm_treap", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "lwt_test.ml"});
               Executable
                 ({
                     cs_name = "test_ie";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "test_ie.ml"});
               Executable
                 ({
                     cs_name = "punycode_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "punycode_test.ml"});
               SrcRepo
                 ({
                     cs_name = "github";
                     cs_data = PropList.Data.create ();
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "git://github.com/ermine/xmpp.git";
                      src_repo_browser =
                        Some "https://github.com/ermine/xmpp";
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "P\167MRy\171;\155\191\182\217.\238\152\148p";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
